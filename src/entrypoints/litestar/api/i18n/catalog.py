...
MESSAGES: Mapping[LanguageEnum, LanguageMessages] = {
    LanguageEnum.RU: {
        ...
        "account.settings.saveFailed": "Не удалось сохранить настройки. Попробуйте выбрать значение ещё раз.",
        "account.settings.loadFailed": "Не удалось загрузить настройки.",
        "account.settings.applyFailed": "Не удалось загрузить выбранный язык. Сохранённые настройки не изменены.",
    ...
    LanguageEnum.EN: {
        ...
        "account.settings.applyFailed": "Could not load the selected language. Your saved settings are unchanged.",
